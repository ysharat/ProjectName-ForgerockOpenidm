    ...
    UserModel = AbstractModel.extend({
        ...
        sync: function sync(method, model, options) {
            ...
            if (method === "update" || method === "patch") {
                ...
                if (this.component === "internal/user" && method === "patch") {
        ...
        getUIRoles: function getUIRoles(roles) {
            ...
            _.each(Configuration.globalData.roles, function (value, key) {
                if (key.indexOf("/") === -1) {
                    Configuration.globalData.roles["internal/role/" + key] = value;
                    delete Configuration.globalData.roles[key];
                }
            });
        ...
        invalidateSession: function invalidateSession() {
            ...
            // Check for am session to logout
            if (sessionStorageTarget.getItem("amToken")) {
                tempHeaders = {
                    "X-OpenIDM-OAuth-Login": true,
                    "X-Requested-With": "XMLHttpRequest",
                    "X-OpenIDM-DataStoreToken": sessionStorageTarget.getItem("amToken")
                };
            } else {
                tempHeaders = {
        ...
        logout: function logout() {
            ...
            return this.invalidateSession().then(function () {
                ...
                sessionStorageTarget.removeItem("amToken");
        ...
        getProfile: function getProfile(headers) {
            ...
            return ServiceInvokerTarget.restCall({
                ...
                */
                if (_.contains(sessionDetails.authorization.roles, "internal/role/openidm-authenticated")) {
                    /*
