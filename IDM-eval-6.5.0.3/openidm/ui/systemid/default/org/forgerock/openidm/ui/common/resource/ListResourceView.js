    ...
    var ListResourceView = AbstractView.extend({
                ...
                if (schema !== "invalidObject") {
                    ...
                    if (schema) {
                        ...
                        if (_.has(this.data, "overrides.customColumns")) {
                            _.each(this.data.overrides.customColumns, function (col) {
                                cols.push(col);
                            });
                        }
        ...
        render: function render(args, callback) {
            ...
            if (this.data.objectType === "system") {
                ...
                this.data.hideTitle = true;
                this.data.objectName += "/" + args[2];
                this.data.resourcePath = args[0] + "/" + args[1] + "/" + args[2];
                this.data.systemType = args[3];
                this.element = this.systemObjectElement;
            } else if (_.has(this.data, "overrides")) {
                if (_.has(this.data.overrides, "hideTitle")) {
                    this.data.hideTitle = this.data.overrides.hideTitle;
                }

                if (_.has(this.data.overrides, "element")) {
                    this.element = this.data.overrides.element;
                }

                if (_.has(this.data.overrides, "noBaseTemplate")) {
                    this.noBaseTemplate = this.data.overrides.noBaseTemplate;
                }

                if (_.has(this.data.overrides, "customColumns")) {
                    this.noBaseTemplate = this.data.overrides.customColumns;
                }
            }
