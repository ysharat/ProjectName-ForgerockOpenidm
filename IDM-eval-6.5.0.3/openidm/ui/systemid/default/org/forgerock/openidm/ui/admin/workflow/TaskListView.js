                ...
                this.$el.find("#taskAssignedTo").selectize({
                    ...
                    onChange: _.bind(function (value) {
                        if (value === "anyone") {
                            ...
                            Tasks.url = Constants.context + "/workflow/taskinstance?_queryId=filtered-query&assignee=" + this.$el.find("#taskAssignedTo")[0].selectize.options[value].userName;
                        }
