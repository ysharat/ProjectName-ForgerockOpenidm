...
define(["org/forgerock/openidm/ui/common/util/Constants"], function (constants) {
    var obj = {
        moduleDefinition: [{
            ...
            configuration: {
                routes: {},
                loader: [{ "routes": "config/routes/CustomIDMRoutesConfig" },{ "routes": "config/routes/CommonRoutesConfig" }, { "routes": "config/routes/CommonIDMRoutesConfig" }, { "routes": "config/routes/AdminRoutesConfig" }]
            }
        }, {
