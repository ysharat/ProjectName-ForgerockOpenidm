...
define(["jquery", "underscore", "org/forgerock/commons/ui/common/main/AbstractView", "org/forgerock/commons/ui/common/main/Configuration", "org/forgerock/commons/ui/common/util/UIUtils", "org/forgerock/openidm/ui/admin/util/InlineScriptEditor", "org/forgerock/openidm/ui/admin/mapping/util/LinkQualifierFilterEditor", "org/forgerock/openidm/ui/admin/util/WorkflowWidget", "org/forgerock/openidm/ui/common/util/BootstrapDialogUtils"], function ($, _, AbstractView, conf, uiUtils, InlineScriptEditor, LinkQualifierFilterEditor, WorkflowWidget, BootstrapDialogUtils) {
            ...
            BootstrapDialogUtils.createModal({
                ...
                onshown: function onshown() {
                    uiUtils.renderTemplate(_this.template, _this.$el, _.extend({}, conf.globalData, _this.data), _.bind(function () {
                        ...
                        this.$el.find('a[data-toggle="tab"]').on('shown.bs.tab', _.bind(function () {
