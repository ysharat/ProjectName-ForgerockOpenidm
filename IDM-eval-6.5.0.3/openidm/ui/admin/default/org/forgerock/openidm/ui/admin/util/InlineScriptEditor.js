...
define(["jquery", "underscore", "jsonEditor", "org/forgerock/commons/ui/common/main/AbstractView", "libs/codemirror/lib/codemirror", "libs/codemirror/mode/groovy/groovy", "libs/codemirror/mode/javascript/javascript", "libs/codemirror/addon/display/placeholder", "org/forgerock/openidm/ui/common/delegates/ScriptDelegate", "org/forgerock/commons/ui/common/main/ValidatorsManager", "org/forgerock/openidm/ui/admin/util/WorkflowWidget"], function ($, _, JSONEditor, AbstractView, codeMirror, groovyMode, jsMode, placeHolder, ScriptDelegate, validatorsManager, WorkflowWidget) {
    var seInstance = {},
        ...
        */
        ...
        localScriptChange: function localScriptChange(event) {
            ...
            if (!this.data.disableValidation) {
                ...
                } else if (this.cmBox.getValue().length > 0) {
                    this.model.codeMirrorValid = true;
                } else {
                    this.model.codeMirrorValid = false;
                }
        ...
        generateScript: function generateScript() {
            ...
            if (currentSelection === "none") {
                ...
                if (currentSelection === "file-code") {
                    scriptObject.file = this.$el.find(".scriptFilePath[type='text']").val();
