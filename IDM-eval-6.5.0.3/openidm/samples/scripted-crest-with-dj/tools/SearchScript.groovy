...
import org.forgerock.openicf.connectors.scriptedcrest.CRESTFilterVisitor
import org.forgerock.openicf.connectors.scriptedcrest.ScriptedCRESTConfiguration
import org.forgerock.openicf.connectors.scriptedcrest.VisitorParameter
                ...
                handler {
                    ...
                    objectClassInfo.attributes.each { key, value ->
                        if (AttributeUtil.namesEqual(key, Name.NAME)) {
                            id resource.content.get("_id").required().asString()
